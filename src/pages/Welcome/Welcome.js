    ...
    return (
        <SafeAreaView style={styles.page}>
            ...
            <View style={styles.body}>
                ...
                <Image style={{ height: '50%', width: '100%', resizeMode: 'cover', marginTop: 20 }} source={welcomePhotoOne} />
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <View style={{ alignItems: 'center', justifyContent: 'center', flexDirection: 'row', paddingTop: 10, }}>
                    ...
                    <View style={{ paddingTop: 25, alignItems: 'center' }}>
                        <Pressable style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: '#64b48e', width: '75%', borderRadius: 18 }}>
